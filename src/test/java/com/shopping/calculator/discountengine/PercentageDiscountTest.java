...
public class PercentageDiscountTest {
    ...
    public void testApplyDiscountSingleItem() {
        ...
        Discounts percDiscount = new PercentageDiscount("10 % Apple Discount", "Apple 10% off :", new BigDecimal(0.10), LocalDate.now(), LocalDate.of(2019, 01, 30), product);
        ...
        assertEquals(order.getDiscountDetails().get(0), "Apple 10% off :-10 p");
    ...
    public void testApplyDiscountMultipleItems() {
        ...
        Discounts percDiscount1 = new PercentageDiscount("20 % Apple Discount", "Apple 20% off :", new BigDecimal(0.20), LocalDate.now(), LocalDate.of(2025, 10, 30), product1);
        ...
        assertEquals("Apple 20% off :-20 p", order.getDiscountDetails().get(0));
